...
// MFCkraevaya.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCkraevayaApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMFCkraevayaApp::OnAppAbout)
...
// Создание CMFCkraevayaApp

CMFCkraevayaApp::CMFCkraevayaApp() noexcept
{
	...
	SetAppID(_T("MFCkraevaya.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMFCkraevayaApp

CMFCkraevayaApp theApp;


// Инициализация CMFCkraevayaApp

BOOL CMFCkraevayaApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMFCkraevayaDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CMFCkraevayaView));
	if (!pDocTemplate)
		return FALSE;
...
int CMFCkraevayaApp::ExitInstance()
{
...
// Обработчики сообщений CMFCkraevayaApp
...
void CMFCkraevayaApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
